...
final public class AWSMobileClient: _AWSMobileClient {
    ...
    internal var customRoleArnInternal: String?

    internal var signInURIQueryParameters: [String: String]?
    internal var tokenURIQueryParameters: [String: String]?
    internal var signOutURIQueryParameters: [String: String]?
    ...
    internal var pendingAWSCredentialsCompletion: ((AWSCredentials?, Error?) -> Void)?

    // Used as lock when waiting for tokens, currently used by hostedUI auth
    internal var pendingGetTokensCompletion: ((Tokens?, Error?) -> Void)?

    internal weak var developerNavigationController: UINavigationController?
